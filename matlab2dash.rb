class Matlab2dash < Formula
  ...
  homepage "https://github.com/acbetter/matlab-to-dash-docset/releases"
  url "https://github.com/acbetter/matlab-to-dash-docset/releases/download/v1.2/matlab2dash.tgz"
